...
def process():
    ...
    * .current_global
    ...
    comets_params.set_param('timeStep', global_params['simulatedTime']/global_params['timeSteps']) # timeStep = simulatedTime / maxCycles (number of steps) //might want to change variable name for timeSteps to maxCycles

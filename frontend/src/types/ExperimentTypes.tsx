...
const layout = ["9 cm Petri Dish (Center Colony)", "9 cm Petri Dish (Random Lawn)", "10 ml Test Tube", "EcoFab"];
const media = ["Core Glucose", "Core Acetate", "M9 Minimal Glucose", "M9 Minimal Acetate", "LB Rich"]
